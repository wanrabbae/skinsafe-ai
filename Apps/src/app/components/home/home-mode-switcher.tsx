...
export type HomeVariant = "with-profile" | "onboarding";

export function HomeModeSwitcher({ initialVariant }: { initialVariant: HomeVariant }) {
  const [variant, setVariant] = useState<HomeVariant>(initialVariant);
    ...
    <>
      ...
      {process.env.NODE_ENV !== "production" && (
        <button
          ...
          onClick={() =>
            setVariant((current) => (current === "with-profile" ? "onboarding" : "with-profile"))
          }
        >
